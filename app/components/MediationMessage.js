...
var MediationMessage = React.createClass({
  render: function () {
    if ( !this.props.mediation && this.props.message.status === "0"|| this.props.incomingMessage.filename === this.props.message.filename && this.props.message.status === "0" ) {
      var status = <i className="fa fa-check icon-right-align success-icon" aria-hidden="true"></i>
    } else if ( !this.props.mediation && this.props.message.status !== "0"|| this.props.incomingMessage.filename === this.props.message.filename && this.props.message.status !== "0") {
