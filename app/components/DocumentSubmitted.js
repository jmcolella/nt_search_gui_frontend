  ...
  return (
    <div className="form-group">
      ...
      <div className="col-lg-4 col-md-4 col-sm-4">
        <input id={ props.data.doc + "-interval" } className="form-control interval-input form-center" type="number" name={ props.data.doc + "-interval" } placeholder="interval to check" />
      </div>
