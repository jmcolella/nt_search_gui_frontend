  ...
  render: function() {
    return (
      <div className="individual-folder-container">
        ...
        <h3 className="pointer folder-document-icon-name folder" onClick={this.handleClick} onMouseEnter={ this.props.onMouseOver } onMouseLeave={ this.props.onMouseDepart }><a className="dark-link">{ this.props.data.name }</a></h3>
      </div>
    )
  }
});
